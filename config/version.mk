...
# Versioning System
ORGASMIC_CODENAME := Saxx
ORGASMIC_NUM_VER := 0.2
...
ORGASMIC_VERSION := $(ORGASMIC_BUILD_VERSION)-$(ORGASMIC_BUILD_TYPE)-$(ORGASMIC_BUILD)-$(BUILD_DATE)-$(BUILD_TIME)
ifeq ($(WITH_GAPPS), true)
ORGASMIC_VERSION := $(ORGASMIC_VERSION)-elgoog
else
ORGASMIC_VERSION := $(ORGASMIC_VERSION)-nogoolag
endif
